...
REPLICATION_TIME_TOLERANCE=7200 # = 2h
OUT=""
...
check_init_failures() {
  ...
  local cores_with_init_failures=$(xmlstarlet sel -t -m "/response/lst[@name='initFailures']/str" -m "@name" -v . <<< "${cores_status="$1"}")
...
=head1 EXAMPLES
  ...
  checksolr -H qa-c1-solrmst1 -P 80 -D 900

=head1 AUTHOR



diveyez@r2nhosting.com
