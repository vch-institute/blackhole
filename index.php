...
<!-- MAIN CONTENT (SEARCH)-->
			  		<div class="tooltip">
						<span class="tooltiptext">Libraries:<p>"This is whatever you called the core during setup. I have many. ie: 'library' "</b> </br> Server: localhost</span><form method="post" action="search.php">
            ...
            <input class="button1" name="submit" type="submit" value="Search The Galaxy"/></p></form></div></br>
						...
						<!-- SEARCH CHEAT SHEET =P -->
						      <div id="cheats">
						      <b> The following is a sort of, cheat sheet for search queries.</b> <b> View the <a href="queries.php">Queries Explained</a> page for explainations.</b></br>
						      <p>"phraseyouwish"</p> <p>"adam +laverne"</p> <p>"bitcoin $6000..$80000"</p> <p>"'MICHAEL'*'DOUGLAS'"</p> <p>"'-MICHAEL'*'-DOUGLAS'"</p></br>
						      <p>"Something I Need To Find&hl.q=Something More Specific From That Document, Site, Etc. -*"</p><p>"Website.com:phrase/sentence" "booktitle:phrase/sentence"</p></br>
						      <p>"website1.com site:website2.com"</p><p>"Medicine book:'Antibiotics'-*"</p><p>"DAY:DATE Monday:February 1, MONTH:YEAR '1790'&hl.q=sumreme court&-*"</p></br>
						      <p>"Alcohol vs. Wine"</p><p>"DEFINE: 'whats on your mind'".</p><p>"How To book:'DEFINE: Home Made Solar Panels'-*"</p></br>
						      <p>"DEFINE:DAY:DATE Monday:February 1, MONTH:YEAR '1790'&hl.q=sumreme court&-*"</p></br></div>
						<!-- SEARCH CHEAT SHEET =P -->
