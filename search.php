<html><head><meta charset="UTF-8"/>
  		...
  		<meta name="keywords" content="Bringing Solr Indexing and Machine Learning Interfacing to your Data Directories."/>
...
<!-- MAIN CONTENT (SEARCH ARRAY CODE)-->
			...
			<?php
				if($_POST['search']) { echo "</br>Search Successful, here are the results."; }
								...
								curl_setopt($ch,CURLOPT_URL,"http://".$encode2.":8983/solr/".$encode1."/select?q=".$encode."&fl=id&fl=score&fl=highlighting&fl=content&fl=manu&indent=true&hl=true&hl.q=".$encode."&hl.snippets=1&hl.method=unified&hl.bs.type=SENTENCE&hl.maxAlternateFieldLength=5&hl.encoder=html&wt=php&hl.tag.pre=<b>&hl.tag.post=</b>&hl.usePhraseHighlighter=true&hl.maxAnalyzedChars=15&results=50&hl.requireFieldMatch=true");
