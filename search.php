...
<style>
	...
	curl_setopt($ch, CURLOPT_URL, "http://".$encode2.":8983/solr/".$encode1."/select?q=".$encode."&fl=id&fl=score&wt=php&indent=true&&hl=on&debugQuery=on&rows=5000&hl.fl=".$encode."");
	...
	echo "</br>"; foreach($arr['response']['docs'] as $item) { echo "<b></b> <p1> " . $item['id'] . "</p1><p2><b>Score:</b>" . $item['score'] . . $item['hightlighting'] . "</p2>\n"; echo "</br>"; }
