...
<!-- MAIN CONTENT (SEARCH ARRAY CODE)-->
			...
			<?php
				if($_POST['search']) { echo "</br>Search Successful, here are the results."; }
								...
								curl_setopt($ch,CURLOPT_URL,"http://".$encode2.":8983/solr/".$encode1."/select?q=".$encode."&fl=id&fl=score&fl=highlighting&fl=content&fl=manu&indent=true&hl=true&hl.q=".$encode."&hl.snippets=1&hl.method=unified&hl.bs.type=WORD&hl.maxAlternateFieldLength=125&hl.encoder=php&wt=php&hl.tag.pre=<b>&hl.tag.post=</b>&hl.usePhraseHighlighter=true&hl.maxAnalyzedChars=250&results=50&hl.requireFieldMatch=true&hl.fl=*&&hl.alternateField=*");
                curl_setopt($ch, CURLOPT_HEADER, false);
								...
								{ echo "<div id='ww2'><pcontent><b>Found:</b></br><b>" . $text['id'] . "</b></br>" .$text['highlighting'] . "</br>" . "\n</pcontent></div></br></br>"; } //echo implode(',', $arr), "\n";// ?>
							</div></div></br>
<!-- MAIN CONTENT (SEARCH) -->
<!-- FOOTER REGION-->
