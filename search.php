...
<!-- MAIN CONTENT (SEARCH ARRAY CODE)-->
			...
			<?php
                ...
                foreach($arr['response']['groups'] as $text) { echo "<div id='ww2'><pcontent><b>Found:</b></br><b>" . $text['id'] . "</b></br>" .$text['highlighting'] . "</br>" . "\n</pcontent></div></br></br>"; }  ?>
