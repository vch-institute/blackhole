...
<style>
	...
	curl_setopt($ch, CURLOPT_URL, "http://".$encode2.":8983/solr/".$encode1."/select?q=".$encode."&fl=id&fl=score&wt=php&indent=true&hl=on&debugQuery=on&rows=5000&hl.snippets=1&hl.fragsize=0&hl.fl=".$encode."");
